...
import com.suyi.dms.filter.KickoutSessionFilter;
import com.suyi.dms.shiro.MyRealm;
import com.suyi.dms.utils.ParamsPojo;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        // 未授权时跳转的界面;
        bean.setUnauthorizedUrl("/page/404.html");
...
//        filterMap.put("/dms/dormitory/list","perms[user:admin]");
        filterMap.put("/dms/login/*", "anon");
...
//        filterMap.put("/layout", "anon");
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher() {
        ...
        hashedCredentialsMatcher.setHashIterations(ParamsPojo.hashIteration);// 散列的次数，比如散列两次，相当于 // md5(md5(""));
    ...
    public EhCacheManager ehCacheManager(){
        ...
        if(cacheManager == null){
            try {
                cacheManager = CacheManager.create(ResourceUtils.getInputStreamForPath("classpath:com/suyi/dms/config/ehcache.xml"));
